...
const BeAmerchant = () => {
  return (
    <div
      className={`bg-[#03373D] bg-[url(/be-amerchant-bg.png)] bg-no-repeat rounded-xl bg-blend-lighten  flex items-center p-10`}
    >
      <div className="flex-2 text-base-100 space-y-5">
