...
const DeliveryAssignModal = ({ wareHouse, parcelId, refetch }) => {
  ...
  const handleAssign = () => {
    ...
    axiosSecure
      .put(`/parcel/update-status/${parcelId}`, {
        ...
        statusMessage:
          "Agent assigned for delivery. They will contact with reciever soon.",
        ...
        <div className="modal-box w-11/12 max-w-5xl">
          ...
          <div className="my-3">
            <h2 className="text-xl font-bold border-b-2 border-secondary">
              Select An Agent For Deliver this Parcel
            </h2>
